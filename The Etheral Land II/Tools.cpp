...
std::vector<sf::Sprite> Tools::DisplayCreator(sf::RenderWindow &window, sf::Texture &GUI, sf::Texture &Buttons) {
    
    sf::IntRect FramedButtonDisabled(0, 0, 300, 190);
    sf::IntRect FramedButtonActive(300,0,300,190);
    
    sf::Sprite SexButton1Disabled(Buttons);
    SexButton1Disabled.setTextureRect(FramedButtonDisabled);
    SexButton1Disabled.setPosition(sf::Vector2f(100, window.getSize().x/2-SexButton1Disabled.getLocalBounds().width/2));
    
    sf::Sprite SexButton1Active(Buttons);
    SexButton1Active.setTextureRect(FramedButtonActive);
    SexButton1Active.setPosition(sf::Vector2f(100, window.getSize().x/2-SexButton1Active.getLocalBounds().width/2-100));
    
    sf::Sprite SexButton2Active(Buttons);
    SexButton2Active.setTextureRect(FramedButtonActive);
    SexButton2Active.setPosition(sf::Vector2f(1000, window.getSize().x/2-SexButton1Active.getLocalBounds().width/2-100));
    
    sf::Sprite SexButton2Disabled(Buttons);
    SexButton2Disabled.setTextureRect(FramedButtonDisabled);
    SexButton2Disabled.setPosition(sf::Vector2f(1000, window.getSize().x/2-SexButton2Disabled.getLocalBounds().width/2));
    
    return {SexButton1Disabled,SexButton1Active,SexButton2Active,SexButton2Disabled};
}
